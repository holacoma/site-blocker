const MESSAGES = {
  es: {
    ...
    blockSiteLabel:         "Bloquear este sitio",
    blockSiteConfirm:       "Confirmar bloqueo",
    blockSiteBlocked:       "Ya bloqueado",
    ...
    defaultTimerLabel:      "Timer por defecto",
    defaultTimerSubtitle:   "Minutos asignados al timer cuando agregás un sitio nuevo.",
    defaultTimerPlaceholder: "min",
    darkModeLabel:          "Modo oscuro",
    darkModeDevice:         "Dispositivo",
    darkModeLight:          "Claro",
    darkModeDark:           "Oscuro",
    darkModeSystemLabel:    "Sistema:",
    darkModeSystemLight:    "claro",
    darkModeSystemDark:     "oscuro",
    themeLabel:             "Tema",
  ...
  en: {
    ...
    blockSiteLabel:         "Block this site",
    blockSiteConfirm:       "Confirm block",
    blockSiteBlocked:       "Already blocked",
    ...
    defaultTimerLabel:      "Default timer",
    defaultTimerSubtitle:   "Minutes assigned to the timer when you add a new site.",
    defaultTimerPlaceholder: "min",
    darkModeLabel:          "Dark mode",
    darkModeDevice:         "Device",
    darkModeLight:          "Light",
    darkModeDark:           "Dark",
    darkModeSystemLabel:    "System:",
    darkModeSystemLight:    "light",
    darkModeSystemDark:     "dark",
    themeLabel:             "Theme",
