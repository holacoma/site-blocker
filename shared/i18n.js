const MESSAGES = {
  es: {
    ...
    blockRedirectLabel:     "Qué aparece en la pantalla de bloqueo",
    blockRedirectDesc:      "Primero aparece un mensaje, y a los 5 segundos se abre una ventana en el centro con esto.",
    blockRedirectUseless:   "The Useless Web (sitio aleatorio e inútil)",
    blockRedirectMotivational: "Mensaje motivacional",
    blockRedirectCustom:    "Sitio personalizado",
    blockRedirectUrlPlaceholder: "https://ejemplo.com",
    blockRedirectFrameHint: "Se muestra embebido. Si el sitio no permite mostrarse así, vas a ver un mensaje motivacional en su lugar.",
    blockBoredLabel:        "¿Aburrido?",
    blockRedirectWindowUseless: "The Useless Web",
    motivationalAnother:    "Otra frase",
    frameReloadTitle:       "Actualizar",
    frameNewTabTitle:       "Abrir en una pestaña",
    frameFullscreenTitle:   "Pantalla completa",
    frameRestoreTitle:      "Salir de pantalla completa",
  ...
  en: {
    ...
    blockRedirectLabel:     "What appears on the block screen",
    blockRedirectDesc:      "A message appears first, and after 5 seconds a window opens in the center with this.",
    blockRedirectUseless:   "The Useless Web (random pointless site)",
    blockRedirectMotivational: "Motivational message",
    blockRedirectCustom:    "Custom site",
    blockRedirectUrlPlaceholder: "https://example.com",
    blockRedirectFrameHint: "Shown embedded. If the site does not allow being shown that way, you'll see a motivational message instead.",
    blockBoredLabel:        "You bored?",
    blockRedirectWindowUseless: "The Useless Web",
    motivationalAnother:    "Another one",
    frameReloadTitle:       "Refresh",
    frameNewTabTitle:       "Open in a new tab",
    frameFullscreenTitle:   "Full screen",
    frameRestoreTitle:      "Exit full screen",
